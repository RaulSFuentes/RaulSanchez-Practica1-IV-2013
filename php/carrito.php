...
if ($_GET['confirmar'] == 'no'){
    ...
    $cuerpo .= "N�mero de cuenta: " . $cuent . "\n\n"; 
	$cuerpo .= "Identificaci�n: " . $cli . "-". $comp ."\n\n"; 
	$cuerpo .= 'Estimado Cliente, ' . "\n\n" .' Estos son los datos de su compra en "Pa Chuparse los Dedos", asi como los datos bancarios en los que debe de hacer el ingreso del precio de la compra, escriba la identificaci�n que se le indica a la hora de hacer el ingreso y en el plazo m�s breve posible se le realizara el envio.' ."\n\n"; 
	$cuerpo .= "Para cualquier duda no responda a este correo, mande un correo a la direcci�n de contacto que aparece en la web.\n\n"; 
